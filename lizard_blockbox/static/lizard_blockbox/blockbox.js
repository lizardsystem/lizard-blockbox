...
(function() {
  ...
  deselectAllMeasures = function() {
    return $.get($('#blockbox-deselect-all-measures').data('deselect-url'), (function(_this) {
  ...
  MeasuresMapView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      $.getJSON(this.static_url + 'lizard_blockbox/measures.json' + '?' + new Date().getTime(), (function(_this) {
      ...
      $.getJSON(this.static_url + 'lizard_blockbox/kilometers.json' + '?' + new Date().getTime(), (function(_this) {
        return function(json) {
      ...
      return $.getJSON(json_url + '?' + new Date().getTime(), (function(_this) {
        return function(data) {
    ...
    render: function(updateRivers, updateMeasures, updateCalculate) {
      ...
      if (updateCalculate) {
        json_url = $('#blockbox-table').data('calculated-measures-url');
        $.getJSON(json_url + '?' + new Date().getTime(), (function(_this) {
          return function(data) {
            _this.calculated = data;
            setFlotSeries(data);
            if (updateRivers) {
  ...
  setMeasureGraph = function(control_data, cities_data) {
    var cities, city, city_points, d4, d5, graphx, graphy, included_measures, key, label_mapping, measure, measures, measures_controls, non_selectable_measures, num, offset, options, pl_control, pl_lines, point, previousPoint, px, py, selected_measures, selected_river, text, value, width, yticks, _i, _j, _len, _len1, _ref, _ref1, _results;
    measures = (function() {
      var _i, _len, _results;
      _results = [];
    ...
    non_selectable_measures = (function() {
      ...
      for (_i = 0, _len = control_data.length; _i < _len; _i++) {
        num = control_data[_i];
        if (!num.selectable && num.show && !num.included) {
          _results.push([num.km_from, num.type_index, num.name, num.short_name, num.measure_type]);
        }
      }
      return _results;
    })();
    included_measures = (function() {
      var _i, _len, _results;
      _results = [];
      for (_i = 0, _len = control_data.length; _i < _len; _i++) {
        num = control_data[_i];
