...
urlpatterns = [
    ...
    url(r"^csv/$", views.generate_csv, name="lizard_blockbox.generate_csv"),
    url(
    ...
    url(r"^select_river/$", views.select_river, name="lizard_blockbox_select_river"),
    url(r"^select_year/$", views.select_year, name="lizard_blockbox_select_year"),
    url(
    ...
    url(r"^api/vertex/list/$", views.vertex_json, name="lizard_blockbox_vertex_list"),
    url(r"^select_vertex/$", views.select_vertex, name="lizard_blockbox_select_vertex"),
    url(
