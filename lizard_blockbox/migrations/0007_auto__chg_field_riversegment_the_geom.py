...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RiverSegment.the_geom'
        db.alter_column('lizard_blockbox_riversegment', 'the_geom', self.gf('django.contrib.gis.db.models.fields.PointField')(srid='4326', null=True))


    def backwards(self, orm):
        
        # Changing field 'RiverSegment.the_geom'
        db.alter_column('lizard_blockbox_riversegment', 'the_geom', self.gf('django.contrib.gis.db.models.fields.PointField')(srid='28992', null=True))
