...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reach.number'
        db.add_column('lizard_blockbox_reach', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Measure.minimal_investment_costs'
        db.alter_column('lizard_blockbox_measure', 'minimal_investment_costs', self.gf('lizard_blockbox.fields.EmptyStringUnknownFloatField')(null=True))

        # Changing field 'Measure.maximal_investment_costs'
        db.alter_column('lizard_blockbox_measure', 'maximal_investment_costs', self.gf('lizard_blockbox.fields.EmptyStringUnknownFloatField')(null=True))

        # Changing field 'Measure.investment_costs'
        db.alter_column('lizard_blockbox_measure', 'investment_costs', self.gf('lizard_blockbox.fields.EmptyStringUnknownFloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Reach.number'
        db.delete_column('lizard_blockbox_reach', 'number')


        # Changing field 'Measure.minimal_investment_costs'
        db.alter_column('lizard_blockbox_measure', 'minimal_investment_costs', self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True))

        # Changing field 'Measure.maximal_investment_costs'
        db.alter_column('lizard_blockbox_measure', 'maximal_investment_costs', self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True))
