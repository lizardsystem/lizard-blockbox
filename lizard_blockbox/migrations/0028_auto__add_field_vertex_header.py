...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vertex.header'
        db.add_column('lizard_blockbox_vertex', 'header', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vertex.header'
        db.delete_column('lizard_blockbox_vertex', 'header')
