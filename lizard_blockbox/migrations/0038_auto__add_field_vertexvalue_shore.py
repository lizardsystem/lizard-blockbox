...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VertexValue.shore'
        db.add_column('lizard_blockbox_vertexvalue', 'shore',
                      self.gf('django.db.models.fields.CharField')(default='BOTH', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VertexValue.shore'
        db.delete_column('lizard_blockbox_vertexvalue', 'shore')
    ...
    models = {
        ...
        'lizard_blockbox.vertexvalue': {
            ...
            'shore': ('django.db.models.fields.CharField', [], {'default': "'BOTH'", 'max_length': '4'}),
