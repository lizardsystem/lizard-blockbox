...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_blockbox_trajectory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('lizard_blockbox', ['Trajectory'])

        # Adding M2M table for field reach on 'Trajectory'
        db.create_table('lizard_blockbox_trajectory_reach', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trajectory', models.ForeignKey(orm['lizard_blockbox.trajectory'], null=False)),
            ('reach', models.ForeignKey(orm['lizard_blockbox.reach'], null=False))
        ))
        db.create_unique('lizard_blockbox_trajectory_reach', ['trajectory_id', 'reach_id'])


    def backwards(self, orm):
        
        # Deleting model 'Trajectory'
        db.delete_table('lizard_blockbox_trajectory')

        # Removing M2M table for field reach on 'Trajectory'
        db.delete_table('lizard_blockbox_trajectory_reach')
