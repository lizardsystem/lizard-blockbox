...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VertexValue'
        db.create_table('lizard_blockbox_vertexvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vertex', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_blockbox.Vertex'])),
            ('riversegment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_blockbox.RiverSegment'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('lizard_blockbox', ['VertexValue'])

        # Adding model 'Vertex'
        db.create_table('lizard_blockbox_vertex', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lizard_blockbox', ['Vertex'])

        # Adding M2M table for field named_reaches on 'Vertex'
        db.create_table('lizard_blockbox_vertex_named_reaches', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vertex', models.ForeignKey(orm['lizard_blockbox.vertex'], null=False)),
            ('namedreach', models.ForeignKey(orm['lizard_blockbox.namedreach'], null=False))
        ))
        db.create_unique('lizard_blockbox_vertex_named_reaches', ['vertex_id', 'namedreach_id'])


    def backwards(self, orm):
        
        # Deleting model 'VertexValue'
        db.delete_table('lizard_blockbox_vertexvalue')

        # Deleting model 'Vertex'
        db.delete_table('lizard_blockbox_vertex')

        # Removing M2M table for field named_reaches on 'Vertex'
        db.delete_table('lizard_blockbox_vertex_named_reaches')
