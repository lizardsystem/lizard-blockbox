...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaterLevelDifference.reference_value'
        db.delete_column('lizard_blockbox_waterleveldifference', 'reference_value_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('lizard_blockbox_referencevalue', (
            ...
            ('reference', self.gf('django.db.models.fields.FloatField')()),
        ...
        # User chose to not deal with backwards NULL issues for 'WaterLevelDifference.reference_value'
        raise RuntimeError("Cannot reverse this migration. 'WaterLevelDifference.reference_value' and its values cannot be restored.")
