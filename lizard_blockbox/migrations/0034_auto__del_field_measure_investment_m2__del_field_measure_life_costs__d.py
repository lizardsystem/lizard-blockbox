...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Measure.minimal_investment_costs'
        db.add_column('lizard_blockbox_measure', 'minimal_investment_costs',
                      self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Measure.maximal_investment_costs'
        db.add_column('lizard_blockbox_measure', 'maximal_investment_costs',
                      self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('lizard_blockbox_measure', 'investment_m2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Measure.life_costs'
        db.add_column('lizard_blockbox_measure', 'life_costs',
                      self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Measure.total_costs'
        db.add_column('lizard_blockbox_measure', 'total_costs',
                      self.gf('lizard_blockbox.fields.EmptyStringFloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Measure.minimal_investment_costs'
        db.delete_column('lizard_blockbox_measure', 'minimal_investment_costs')

        # Deleting field 'Measure.maximal_investment_costs'
        db.delete_column('lizard_blockbox_measure', 'maximal_investment_costs')
    ...
    models = {
        ...
        'lizard_blockbox.measure': {
            ...
            'maximal_investment_costs': ('lizard_blockbox.fields.EmptyStringFloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'minimal_investment_costs': ('lizard_blockbox.fields.EmptyStringFloatField', [], {'null': 'True', 'blank': 'True'}),
