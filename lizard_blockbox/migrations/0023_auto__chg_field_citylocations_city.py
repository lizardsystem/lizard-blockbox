...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CityLocations.city'
        db.alter_column('lizard_blockbox_citylocations', 'city', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'CityLocations.city'
        db.alter_column('lizard_blockbox_citylocations', 'city', self.gf('django.db.models.fields.CharField')(max_length=10))


    models = {
        'lizard_blockbox.citylocations': {
            'Meta': {'object_name': 'CityLocations'},
